...
DEFAULT_CLFRAMEWORKREVISION="c42b00e9f07830679cbe517b6e3551e8311bd9eb" # fix: Minor fix to recently added code: perform null check before accessing the object.
usage() {
